...
@NcpfRegistered("")
@JsonAdapter(UnknownElement.Adapter.class)
public class UnknownElement extends NcpfElement{
    private LinkedHashMap<String, JsonElement> rawJson = new LinkedHashMap<>();
    public static class Adapter extends TypeAdapter<UnknownElement>{
        @Override
        public void write(JsonWriter out, UnknownElement value) throws IOException{
        ...
        @Override
        public UnknownElement read(JsonReader in) throws IOException{
            JsonObject obj = Streams.parse(in).getAsJsonObject();
            UnknownElement design = new UnknownElement();
